...
export default function AccessoriesPage() {
    ...
    return (
        <main className="container mx-auto px-4 py-10">
            ...
            <p className="mb-8 text-gray-600">Find the perfect accessories to complement your look.</p> */}
                ...
                <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Showing {products.length} of {total} accessories
                            </p>
                        </div>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-muted-foreground mb-4">No accessories found matching your criteria.</p>
