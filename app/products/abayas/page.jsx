...
export default function AbayasPage() {
    ...
    return (
        <main className="container mx-auto px-4 py-10">
            {/* <h1 className="text-3xl font-bold mb-4">Abayas</h1>
            <p className="mb-8 text-gray-600">Discover our elegant collection of Abayas, crafted for style and comfort.</p> */}
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                        <div>
                            <h1 className="text-2xl font-bold">Abayas</h1>
                            <p className="text-muted-foreground">
                                Showing {products.length} of {total} abayas
                            </p>
                        </div>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-muted-foreground mb-4">No abayas found matching your criteria.</p>
